...
class DatFiles {
  ...
  const DatFiles(this.version, this.files, [this.originalFileOrder, this.endian = "little", this.platform]);
}
...
Future<DatFiles> _getDatFileListFromJson(String datInfoPath, bool removeDuplicates) async {
  ...
  var endian = datInfoJson["endian"] is String ? datInfoJson["endian"] as String : "little";
  var platform = datInfoJson["platform"] is String ? datInfoJson["platform"] as String : null;
  return DatFiles(version, files, originalFileOrder, endian, platform);
}
